...
function Form(){
    ...
    const [itemData, setItemData] = useState({
        name: '', price: 0, description: '', selectedFile: []
    })

    function clear(){
        setItemData({ name: '', price: 0, gender:'', description: '', selectedFile: []});
    }
    ...
    return(
        <Paper className={classes.paper}>
            ...
            <TextField name="gender" variant="outlined" label="Gender" fullWidth value={itemData.gender} onChange={(e) => setItemData({ ...itemData, gender: e.target.value })} />
            ...
            <TextField name="sizes" variant="outlined" label="Sizes" fullWidth value={itemData.sizes} onChange={(e) => setItemData({ ...itemData, sizes: e.target.value })} />
            <TextField name="colors" variant="outlined" label="Colors" fullWidth value={itemData.colors} onChange={(e) => setItemData({ ...itemData, colors: e.target.value })} />
            ...
            <div className={classes.fileInput}><FileBase type="file" multiple={true} onDone={(e) => setItemData({ ...itemData, selectedFile: mapImages(e) })} /> </div>
